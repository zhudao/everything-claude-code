...
# ruff: noqa: N802 -- fake objects preserve the public Resolve API method names
...
sys.path.insert(
    0, str(Path(__file__).resolve().parents[1] / "skills/taste-application/scripts")
)
from taste.resolve import allocate_placements, apply_placements, probe_asset
